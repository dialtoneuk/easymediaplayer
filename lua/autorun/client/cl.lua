...
hook.Add("PreGamemodeLoaded", "MediaPlayer.PreGamemodeLoaded", function()
	...
	list.Add( "DesktopWindows", {
		...
		init		= function( icon, window )
			RunConsoleCommand("MediaPlayer_settings")
	...
	list.Add( "DesktopWindows", {
		...
		onewindow	= true,
		init		= function( icon, window )
			RunConsoleCommand("MediaPlayer_search_panel")
	...
	list.Add( "DesktopWindows", {
		...
		init		= function( icon, window )
			...
			RunConsoleCommand("MediaPlayer_like_video")
			--instantly remove
			window:Remove()
		end
	})
	...
	list.Add( "DesktopWindows", {
		...
		init		= function( icon, window )
			...
			RunConsoleCommand("MediaPlayer_dislike_video")
			--instantly remove
			window:Remove()
		end
	})
	...
	list.Add( "DesktopWindows", {
		...
		init		= function( icon, window )
			...
			RunConsoleCommand("MediaPlayer_admin_panel")
			--instantly remove
			window:Remove()
		end
	})
...
concommand.Add("MediaPlayer_youtube_search", function (ply, cmd, args)
...
concommand.Add("MediaPlayer_create_cl", function()
	MediaPlayer.InstantiatePanels(true) --
end)
...
concommand.Add("MediaPlayer_refresh_cl", function()
	MediaPlayer.InstantiatePanels(true, {
...
concommand.Add("MediaPlayer_search_panel", function()
...
concommand.Add("MediaPlayer_admin_panel", function()
...
concommand.Add("MediaPlayer_settings", function()
...
concommand.Add("MediaPlayer_create_search_panel", function()
...
concommand.Add("MediaPlayer_create_admin_panel", function()
...
concommand.Add("MediaPlayer_create_vote_panel", function()
...
concommand.Add("MediaPlayer_create_player_panel", function()
...
concommand.Add("MediaPlayer_create_playlist_panel", function()
...
concommand.Add("MediaPlayer_create_settings_panel",function()
...
net.Receive("MediaPlayer.SendMessage", function()
	...
	local setting = MediaPlayer.GetSetting("MediaPlayer_chat_colours")
...
net.Receive("MediaPlayer.End", function()
	...
	local setting = MediaPlayer.GetSetting("MediaPlayer_player_hide")
